...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'askbot_language', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=120)),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('askbot', ['Language'])

        # Adding model 'Book'
        db.create_table(u'askbot_book', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('edition', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True)),
            ('source_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Language'])),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('askbot', ['Book'])

        # Adding unique constraint on 'Book', fields ['name', 'edition', 'source_language']
        db.create_unique(u'askbot_book', ['name', 'edition', 'source_language_id'])

        # Adding model 'Chapter'
        db.create_table(u'askbot_chapter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('askbot', ['Chapter'])

        # Adding unique constraint on 'Chapter', fields ['book', 'num']
        db.create_unique(u'askbot_chapter', ['book_id', 'num'])

        # Adding field 'Thread.chapter'
        db.add_column(u'askbot_thread', 'chapter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Chapter'], null=True),
                      keep_default=False)

        # Adding field 'Thread.verse_no'
        db.add_column(u'askbot_thread', 'verse_no',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'Thread.title'
        db.alter_column(u'askbot_thread', 'title', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
        # Adding unique constraint on 'Thread', fields ['chapter', 'verse_no']
        db.create_unique(u'askbot_thread', ['chapter_id', 'verse_no'])


    def backwards(self, orm):
        # Removing unique constraint on 'Thread', fields ['chapter', 'verse_no']
        db.delete_unique(u'askbot_thread', ['chapter_id', 'verse_no'])

        # Removing unique constraint on 'Chapter', fields ['book', 'num']
        db.delete_unique(u'askbot_chapter', ['book_id', 'num'])

        # Removing unique constraint on 'Book', fields ['name', 'edition', 'source_language']
        db.delete_unique(u'askbot_book', ['name', 'edition', 'source_language_id'])

        # Deleting model 'Language'
        db.delete_table(u'askbot_language')

        # Deleting model 'Book'
        db.delete_table(u'askbot_book')

        # Deleting model 'Chapter'
        db.delete_table(u'askbot_chapter')

        # Deleting field 'Thread.chapter'
        db.delete_column(u'askbot_thread', 'chapter_id')

        # Deleting field 'Thread.verse_no'
        db.delete_column(u'askbot_thread', 'verse_no')


        # Changing field 'Thread.title'
        db.alter_column(u'askbot_thread', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
    ...
    models = {
        ...
        'askbot.book': {
            'Meta': {'unique_together': "(('name', 'edition', 'source_language'),)", 'object_name': 'Book'},
            'edition': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'source_language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Language']"})
        },
        ...
        'askbot.chapter': {
            'Meta': {'unique_together': "(('book', 'num'),)", 'object_name': 'Chapter'},
        ...
        'askbot.thread': {
            'Meta': {'unique_together': "(('chapter', 'verse_no'),)", 'object_name': 'Thread'},
            ...
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'chapter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Chapter']", 'null': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300', 'null': 'True'}),
            'verse_no': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
